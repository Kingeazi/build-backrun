;; BackRun Challenge Contract
;; This contract manages fitness challenges, user participation, and decentralized reward distribution
;; for the BackRun platform, enabling users to join competitive events, track performance,
;; and earn rewards based on verified activity data.
;; Error codes
